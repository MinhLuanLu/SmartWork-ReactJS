    ...
    useEffect(() => {
        if (FullName == null){
            ...
            const Get_Requestments = async () => {
                ...
                const list_object = { "FullName": get_fullname, 'Status': 'Decline' };
            ...
            <section className="py-10 bg-gray-100 sm:py-16 lg:py-24 mt-5">
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="max-w-2xl mx-auto text-center">
                        <h2 className="text-3xl font-bold leading-tight text-black sm:text-4xl lg:text-5xl">All Your Decline Requestments</h2>
